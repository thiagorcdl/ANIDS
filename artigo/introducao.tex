...
Assim como é possível se conectar de uma máquina pessoal a um servidor \textint{web}, é possível fazer o contrário.
...
arquivos, instalar \textint{malware} e até ganhar controle sobre o sistema sem serem notados pelo dono.
\par A fim de cobrir esse ponto cego, foram criados sistemas de detecção de intrusão, ou IDS
(\textint{intrusiondetection systems}). Seu objetivo é reconhecer comportamentos incomuns dentro de uma rede.
...
\begin{enumerate}
    \item \textint{Signature-based}, ou baseado em assinatura. Esse é o método padrão e atualmente o único utilizado
    comercialmente. Ele possui baixa adaptabilidade a novas ameaças.
    \item \textint{Anomaly-based}, ou baseado em anomalia. Ainda uma área de estudo, possui alta taxa de
