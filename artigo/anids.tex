...
Um modelo de probabilidade de um determinado comportamento é criado a partir da atividade capturada do tráfego de rede,
 ...
 Métodos de aprendizado de máquina exigem um conjunto de dados categorizados para treinar o mdoelo do comportamento
 ...
 \begin{itemize}
    ...
    \item Redes neurais -- cria um rede de \emph{perceptrons} com habilidade de se adaptar.
