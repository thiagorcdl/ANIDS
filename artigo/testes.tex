...
protocolos, como SNMP e SSH. Apenas o grupo \textit{Inicial} foi utilizado para treino. O objetivo é ver o comportamento do sistema quando novos
...
\begin{table}[h]
    ...
    \begin{tabular}{l|l|l|l|l|l|}
        \cline{2-6}
                                                                   ...
                                                                   & $TP_{rate}$ & $FP_{rate}$ & Tempo    & Acertos & Precisão \\ \hline
        \multicolumn{1}{|l|}{\cellcolor[HTML]{EFEFEF}Inicial}      & 0.503       & 0.502       & 14h45min & 98.43\%  & 0.75     \\ \hline
