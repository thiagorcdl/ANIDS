...
%                                                                   & $TP_{rate}$ & $FP_{rate}$ & Tempo    & Acertos & Precisão \\ \hline
%        \multicolumn{1}{|l|}{\cellcolor[HTML]{EFEFEF}Inicial}      & 0.984       & 0.016       & 15h13min & 98.43\%  & 0.984     \\ \hline
%        \multicolumn{1}{|l|}{\cellcolor[HTML]{EFEFEF}Análogo}      & 0.902       & 0.845       & 8h12min  & 90.27\%  & 0.891    \\ \hline
%        \multicolumn{1}{|l|}{\cellcolor[HTML]{EFEFEF}Desconhecido} & 0.51        & 0.493       & 15h29min & 50.78\%  & 0.753     \\ \hline
%    \end{tabular}
%\end{table}
...
A tabela \ref{tab:dtattrless}} mostrm que o resultado do algoritmo nesse
cenário teve nenhum ganho significativo. Enquanto os atributos selecionados podem ser mais descritivos para os
atques vistos na base \textit{Inicial}, talvez não sejam interessantes para identificar os ataques correntes.
  ...
  \centering
    \begin{tikzpicture}
        \begin{axis}[
            ...
            %  DT
            \addplot [ color=blue, mark=*, nodes near coords=DT-I1, every node near coord/.style={anchor=180}]
                coordinates {( 0.018, 0.982)};
            \addplot [ color=blue, mark=*, nodes near coords=DT-A1, every node near coord/.style={anchor=180}]
                coordinates {( 0.856, 0.912 )};
            \addplot [ color=blue, mark=*, nodes near coords=DT-D1, every node near coord/.style={anchor=180}]
                coordinates {( 0.497, 0.503 )};

%            %  SVM
%            \addplot [ color=blue, mark=*, nodes near coords=SVM-I1, every node near coord/.style={anchor=180}]
%                coordinates {( 0.502, 0.503)};
%            \addplot [ color=blue, mark=*, nodes near coords=SVM-A1, every node near coord/.style={anchor=180}]
%                coordinates {( 0.068, 0.068)};
%            \addplot [ color=blue, mark=*, nodes near coords=SVM-D1, every node near coord/.style={anchor=180}]
%                coordinates {( 0.5, 0.5)};

            %  DT_attrless
            \addplot [ color=blue, mark=o, nodes near coords=DT-I2, every node near coord/.style={anchor=180}]
                coordinates {( 0, 1)};
            \addplot [ color=blue, mark=o, nodes near coords=DT-A2, every node near coord/.style={anchor=180}]
                coordinates {( 0.429, 0.848)};
            \addplot [ color=blue, mark=o, nodes near coords=DT-D2, every node near coord/.style={anchor=180}]
                coordinates {( 0.501, 0.499)};

%            %  SVM
%            \addplot [ color=blue, mark=o, nodes near coords=SVM-I2, every node near coord/.style={anchor=180}]
%                coordinates {( 0.502, 0.503)};
%            \addplot [ color=blue, mark=o, nodes near coords=SVM-A2, every node near coord/.style={anchor=180}]
%                coordinates {( 0.068, 0.068)};
%            \addplot [ color=blue, mark=o, nodes near coords=SVM-D2, every node near coord/.style={anchor=180}]
%                coordinates {( 0.5, 0.5)};
