...
\par Tanto o SVM quanto DT foram utilizados nesta análise. A \ref{tab:dt} e a \ref{tab:svm} mostram os resultados
...
análise anterior. A \ref{tab:dtattrless} e a \ref{tab:svmattrless}  mostra o resultado dos algoritmos nesse cenário.
