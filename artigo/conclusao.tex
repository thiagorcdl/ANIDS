...
Neste trabalho, foram analisados os diferentes tipos de dados utilizados para a detecção de intrusões em rede e o
...
dados na rede; análise de dados cifrados e a taxa aceitável de Falso Positivo. Por fim, pude concluir que
 a maior importância nos estudos de detecção de intrusão em rede reside em adquirir uma base de treino e de testes que
 represente precisamente o atual comportamento da rede, pois, caso contrário, não haverá resultados significativos.